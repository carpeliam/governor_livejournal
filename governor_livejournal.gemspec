...
Gem::Specification.new do |s|
  ...
  s.homepage = %q{http://github.com/carpeliam/governor_livejournal}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.7}
  s.summary = %q{A plugin that connects Governor with a LiveJournal account.}
  s.test_files = [
    "spec/governor_livejournal_spec.rb",
    "spec/rails_app/app/controllers/application_controller.rb",
    "spec/rails_app/app/controllers/home_controller.rb",
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<governor_livejournal>, [">= 0"])
      ...
      s.add_dependency(%q<governor_livejournal>, [">= 0"])
